    ...
    <table class="table">
       ...
       <c:forEach items="${productList}" var="product">
        <tr>
         ...
         <td>${product.price}</td>
         <td>${product.condition1}</td>
         
         <td>
          <a class="btn btn-default" href="modifyProduct?product_id=${product.product_id}">修改</a>
          <a class="btn btn-sm btn-danger deleteBtn" href="#" data-toggle="modal" data-target="#deleteModal" data-id="${product.product_id}">刪除</a>
         </td>
        </tr>
       </c:forEach>
    </table>
